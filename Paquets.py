...
class Paquet:
    ...
    def __init__(self, source_ip: str, dest_ip: str, protocole: str, taille: int, priorite: int):
        ...
        :param source_ip: Adresse IPv4 de l'émetteur.
        :param dest_ip: Adresse IPv4 du destinataire.
        :param protocole: TCP, UDP ou ICMP.
        :param taille: Taille en octets.
        :param priorite: Niveau de priorité de 1 (basse) à 5 (haute).
        """
...
class SimulateurTrafic:
    ...
    def _calculer_chemin_bfs(self, depart_nom: str, arrivee_nom: str):
        ...
        Justification pour le rapport : Simple, efficace pour les topologies de taille moyenne et garantit le moins de sauts.
        """
